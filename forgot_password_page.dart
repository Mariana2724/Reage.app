                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10,),
                            Text('Introduza o endereço de e-mail associado à sua conta.',
                              style: TextStyle(
                                // fontSize: 20,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.black54
                            ...
                            SizedBox(height: 10,),
                            Text('Enviaremos um código de verificação por e-mail para verificar sua autenticidade.',
                              style: TextStyle(
                      ...
                      Form(
                        ...
                        child: Column(
                          children: <Widget>[
                            Container(
                              child: TextFormField(
                                decoration: ThemeHelper().textInputDecoration("Email", "Introduza o seu email"),
                                validator: (val){
                                  if(val!.isEmpty){
                            ...
                            Text.rich(
                              TextSpan(
                                children: [
                                  TextSpan(text: "Lembra-se da palavra-passe? "),
                                  TextSpan(
                                    text: 'Login',
